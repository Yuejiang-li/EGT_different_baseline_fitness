function mean_result = DB_infl_CtrlScrpt(uff, ufn, unn, N, k, alpha, iteration_time, percentage, p_ini_1, p_ini_2, B, b, g_type, varargin)
...
%   liyuejiang
    ...
    for i = 1:rand_graph_num
        ...
        parfor j = 1: sim_run_num
            [result_1_all(j,:,i), result_2_all(j,:,i), result_all(j,:,i)] = DB_infl(uff, ufn, unn, graph, alpha, iteration_time, N, percentage, p_ini_1, p_ini_2, B, b);
%             [result_1_all(j,:,i), result_2_all(j,:,i), result_all(j,:,i)] = DB_inflWeight(uff, ufn, unn, graph, alpha, iteration_time, N, percentage, p_ini_1, p_ini_2, B);
