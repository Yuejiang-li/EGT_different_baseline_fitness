function [mean_result, generated_graph] = simulate_DB_est_2_control_script(uff, ufn, unn, N, k, alpha, iteration_time, p_ini, b)
    rand_graph_num = 5;
    sim_run_num = 96;    
...
%             j
            mean_table_2{1, j} = simulate_DB_est_2(uff, ufn, unn, graph, alpha, iteration_time, N, p_ini, b);
        end
        for m = 1:sim_run_num
