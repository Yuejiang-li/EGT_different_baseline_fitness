function [result_1, result_2, result] = DB_inflInsist(uff, ufn, unn, con_matrix, alpha, iterate_time, N, percentage, p_ini_1, p_ini_2, B, b)
% 2019.09.24
% liyuejiang
% All Type 1 users insist their own strategies
    ...
    while count <= iterate_time
        for p = 1:N
            ...
            if i > num_inf  % check whether influential user
